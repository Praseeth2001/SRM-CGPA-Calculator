...
def calculate():
    total_grades = 0
    total_credits = int(n1.get()) + int(n2.get()) + int(n3.get()) + int(n4.get()) + int(n5.get())
    if g1.get() == 'O':
...
if __name__ == '__main__':
    ...
    n1, n2, n3, n4, n5 = StringVar(), StringVar(), StringVar(), StringVar(), StringVar(), 
    global g1, g2, g3, g4, g5
    g1, g2, g3, g4, g5 = StringVar(), StringVar(), StringVar(), StringVar(), StringVar(), 
#Number 1
